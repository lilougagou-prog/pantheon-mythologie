...
const DEITY_NOTES = {
  ...
  "anchise":"Prince troyen aimé d'Aphrodite malgré l'interdit qui pesait sur cet amour, père d'Énée qu'il traversa la chute de Troie porté sur son dos.",
  ...
  "eurysthée":"Roi de Mycènes, cousin d'Héraclès dont la naissance prématurée, orchestrée par Héra, lui valut de lui imposer les douze travaux.",
  ...
  "pélops":"Roi de Pise dans le Péloponnèse, vainqueur d'une course de chars truquée pour épouser Hippodamie, père d'Atrée et Thyeste et origine de la malédiction des Atrides.",
...
const GENEALOGY_PARENTS = {
  ...
  // Le père d'Hécate est bien un Titan nommé Persès (fils de Crios et d'Eurybie) — mais
  // l'unique fiche « persès » de ce corpus est un tout autre personnage, arrière-petit-fils
  // de Persée par Andromède (voir sa fiche). Les relier créerait un lien généalogique erroné
  // entre deux figures homonymes sans rapport : on ne retient donc qu'Astéria ici, la nuance
  // restant à expliquer dans le texte de la fiche d'Hécate elle-même.
  "hécate": ["astéria"],
