...
const DEITY_NOTES = {
  ...
  "persès-titan":"Titan marin, fils de Crios et d'Eurybie, père d'Hécate — sans lien avec ses deux homonymes mortels, l'arrière-petit-fils de Persée et Andromède et le frère usurpateur de Circé, roi de Colchide.",
  "persès-colchide":"Frère d'Aiétès, de Circé et de Pasiphaé, fils d'Hélios et de Perséis — il déposséda son frère du trône de Colchide avant d'être tué à son tour par le fils de Médée, venu venger son grand-père. Sans lien avec ses deux homonymes, l'arrière-petit-fils de Persée et Andromède et le Titan marin père d'Hécate.",
  ...
  "céphale":"Prince grec, époux de Procris, aimé malgré lui de l'Aurore — dont la jalousie de son épouse causa la mort, frappée par le propre javelot infaillible qu'elle lui avait offert.",
