...
const DEITY_NOTES = {
  ...
  "tartare":"L'abîme le plus profond du monde, aussi loin sous la terre que le ciel l'est d'elle, et prison des Titans vaincus.",
  ...
  "hypérion":"Titan de la lumière céleste, père d'Hélios, Séléné et Éos, soit le Soleil, la Lune et l'Aurore.",
  ...
  "laërte":"Roi d'Ithaque, père d'Ulysse, qui l'aida en secret à massacrer les prétendants avant de reprendre les armes une dernière fois à ses côtés.",
  "anticlée":"Reine d'Ithaque, épouse de Laërte et mère d'Ulysse, morte de chagrin durant son absence, dont l'ombre le bouleverse aux Enfers.",
  "ctimène":"Fille de Laërte et d'Anticlée, sœur d'Ulysse, envoyée se marier au loin avant le départ de son frère pour Troie.",
  "autolycos":"Fils d'Hermès, voleur et trompeur incomparable, grand-père maternel d'Ulysse, qui lui donna son nom lors d'une visite à Ithaque.",
  "nausicaa":"Princesse des Phéaciens, fille d'Alcinoos, qui découvrit Ulysse naufragé sur le rivage et le conduisit jusqu'au palais de son père.",
  "alcinoos":"Roi des Phéaciens, il accueillit Ulysse naufragé et le fit reconduire à Ithaque sur l'un de ses navires magiques.",
  "tirésias":"Devin thébain aveugle, dont les prophéties toujours vraies mais jamais crues à temps éclairent aussi bien le destin d'Œdipe que le long retour d'Ulysse, consulté depuis l'au-delà.",
  "perséis":"Nymphe Océanide, fille d'Océan et Téthys, unie à Hélios ; mère de Circé, Aiétès et Pasiphaé.",
  "aiétès":"Roi de Colchide, fils d'Hélios et de Perséis, gardien de la Toison d'or convoitée par Jason, et père de Médée.",
  ...
  "daphné":"Naïade, fille du dieu-fleuve Pénée, poursuivie par Apollon malgré elle et changée en laurier pour lui échapper.",
  ...
  "lethée":"Fleuve des Enfers, personnification de l'Oubli, dont l'eau efface jusqu'au souvenir d'avoir vécu.",
  ...
  "thanatos":"Personnification de la mort paisible, frère jumeau d'Hypnos le Sommeil, inévitable mais jamais cruelle.",
  ...
  "penia":"Personnification de la Pauvreté, mère d'Éros selon Platon, union d'un manque et d'une ressource née un soir de fête.",
  ...
  "aglaé":"La plus jeune des trois Charites, personnifiant l'éclat et la splendeur, et selon certaines traditions l'épouse d'Héphaïstos.",
  ...
  "maïa":"L'aînée des sept Pléiades, fille d'Atlas, mère d'Hermès par Zeus.",
  ...
  "sisyphe":"Roi rusé de Corinthe, condamné pour l'éternité à pousser un rocher qui retombe sans cesse avant d'atteindre le sommet.",
...
// Section « Culte » des 5 figures gratuites (leur mythe complet est déjà hors Premium, donc
// leur culte l'est aussi — demande explicite : une fois qu'une fiche est intégralement
// gratuite, il n'y a pas de raison de verrouiller un seul de ses paragraphes). Toutes les
// autres figures ont leur « culte » dans content.json, au même titre que leur « lore ».
const DEITY_CULT_FREE = {
  "zeus": [
    "Le plus grand sanctuaire de Zeus se trouvait à Olympie, en Élide, où sa statue chryséléphantine de treize mètres, œuvre de Phidias et comptée parmi les Sept Merveilles du monde, dominait son temple ; les Jeux olympiques, célébrés en son honneur tous les quatre ans, rassemblaient athlètes et pèlerins de tout le monde grec le temps d'une trêve sacrée.",
    "À Dodone, en Épire, le plus ancien de ses oracles rendait ses réponses par le bruissement des feuilles d'un chêne sacré, interprété par des prêtres qui dormaient à même le sol. Chaque foyer lui devait aussi un culte plus discret, sous les traits de Zeus Herkeios (gardien de l'enclos familial) et de Zeus Ctésios (voir la fiche « Ctésios »), honoré par un jarre remplie d'offrandes dans le cellier."
  ],
  "héra": [
    "Argos et Samos se disputaient le titre de foyer principal de son culte : l'Héraion d'Argos, sur une colline dominant la plaine, et celui de Samos, l'un des plus vastes temples jamais bâtis en Grèce, abritaient chacun une statue de culte parée chaque année de vêtements neufs lors d'un bain rituel.",
    "Les Héraia, jeux célébrés en son honneur à Olympie même, réservaient aux jeunes filles une course à pied sur une piste raccourcie, l'une des rares compétitions sportives officiellement ouvertes aux femmes dans la Grèce antique. On lui offrait généralement des étoffes tissées, des bijoux et de jeunes vaches, un animal qui lui était particulièrement consacré."
  ],
  "poséidon": [
    "L'Isthme de Corinthe accueillait tous les deux ans les Jeux isthmiques en son honneur, second grand rendez-vous panhellénique après Olympie ; le cap Sounion, à la pointe de l'Attique, portait quant à lui un temple dressé sur une falaise dominant la mer, repère familier des marins rentrant à Athènes.",
    "On lui sacrifiait des taureaux et des chevaux noirs, parfois précipités vivants dans la mer ou dans une source, un animal qu'on disait sa propre création ; les marins, avant d'appareiller, lui versaient des libations pour s'assurer une traversée sans tempête ni tremblement de terre."
  ],
  "apollon": [
    "Delphes restait son sanctuaire le plus prestigieux : les Jeux pythiques, célébrés tous les quatre ans, couronnaient de laurier musiciens, poètes et athlètes, tandis que la Pythie y rendait ses oracles depuis l'adyton du temple. Délos, son île natale, l'honorait par les Délia, une fête maritime où affluaient processions et navires de tout l'Archipel.",
    "On lui offrait du laurier (voir la fiche « Laurier »), des prémices de blé et des premiers fruits de la moisson ; le septième jour de chaque mois lunaire, jour de sa naissance traditionnelle, lui était spécialement consacré dans la plupart des cités grecques."
  ],
  "athéna": [
    "Les Panathénées, célébrées chaque année à Athènes et avec un faste particulier tous les quatre ans, formaient l'événement religieux majeur de la cité : une procession traversait la ville jusqu'à l'Acropole pour offrir à sa statue de bois un péplos neuf, tissé durant l'année par des jeunes filles choisies.",
    "Son temple du Parthénon abritait la statue chryséléphantine de Phidias, haute de plus de onze mètres ; l'huile d'olive, fruit de l'arbre qu'elle avait elle-même offert à la ville, comptait parmi ses offrandes les plus symboliques, avec des amphores remises en récompense aux vainqueurs des jeux Panathénées."
  ],
};
const DEITY_LORE = {"dionysos":[],"hermès":[],"métis":[],"héra":["Fille de Cronos et de Rhéa (voir les fiches « Cronos » et « Rhéa »), Héra fut elle aussi avalée à la naissance par son père, comme tous ses frères et sœurs hormis le petit dernier, Zeus, qui seul y échappa. Rendue au jour par lui une fois devenu adulte, elle devint, à l'issue de la victoire des Olympiens sur les Titans lors de la Titanomachie, reine d'un Olympe nouvellement établi, un règne dont aucune source antique, à la différence de ses frères, ne lui attribue la conquête les armes à la main.","Sœur et épouse de Zeus, Héra règne sur l'Olympe comme protectrice du mariage et garante de l'ordre légitime, un rôle qu'elle défend avec une fermeté que la mythologie associe souvent à la jalousie, tant les infidélités de son époux sont nombreuses.","Elle ne se contente jamais d'observer : elle pousse Sémélé à sa perte par ruse (voir la fiche « Sémélé »), poursuit Héraclès de sa colère toute sa vie durant simplement parce qu'il est le fruit d'une liaison de Zeus (voir la fiche « Héraclès »), et impose à Léto l'interdiction de mettre au monde ses enfants sur la moindre terre ferme, retardant ainsi la naissance d'Apollon et d'Artémis (voir la fiche « Léto »).","Reine avant d'être épouse, elle incarne la légitimité et l'autorité plus que la douceur.","À Argos, son principal foyer de culte, on l'honorait comme Héra Argienne ; mais c'est à Stymphale qu'elle recevait l'hommage le plus original, avec trois sanctuaires distincts dédiés à Héra Pais (l'enfant), Héra Teleia (l'épouse accomplie) et Héra Khéra (la veuve), comme les trois âges d'un même mariage. Une légende argienne ajoutait qu'elle retrouvait chaque année sa virginité en se baignant dans la source de Canathos à Nauplie, un secret réservé à ses mystères, et un renouveau que sa propre réputation de jalousie perpétuelle semble pourtant démentir sans cesse."],"zeus":["Plus jeune fils de Cronos et de Rhéa (voir les fiches « Cronos » et « Rhéa »), Zeus échappa au sort de ses frères et sœurs (avalés à la naissance par un père craignant d'être détrôné) grâce à sa mère, qui le cacha dans une grotte du mont Ida en Crète et fit avaler à Cronos une pierre emmaillotée à sa place.","Devenu adulte, il libéra d'abord ses frères et sœurs engloutis, puis les Cyclopes et les Hécatonchires, monstres aux cent bras enfermés au plus profond du Tartare par leur propre père Ouranos ; en échange de leur délivrance, les Cyclopes lui forgèrent la foudre, son arme absolue. Ainsi armé, il mena dix années durant la guerre contre les Titans, la Titanomachie, jusqu'à les vaincre et les précipiter à leur tour dans le Tartare, désormais gardé par les Hécatonchires eux-mêmes, établissant sur l'Olympe un nouvel ordre cosmique dont il devint le souverain incontesté, maître de la foudre.","Sa victoire eut pourtant un prix : furieuse de voir ses fils titans enchaînés, Gaïa engendra contre l'Olympe une nouvelle race de géants. Une prophétie voulait que les dieux seuls ne puissent en triompher sans l'aide d'un mortel : Zeus fit donc appel à son propre fils Héraclès (voir la fiche « Héraclès »), dont les flèches achevèrent plusieurs des géants déjà terrassés par la foudre olympienne, une victoire collective, la Gigantomachie, à laquelle prirent part la plupart des dieux de l'Olympe, chacun selon ses propres armes.","Garant de l'ordre du monde, il reste pourtant l'un des dieux aux liaisons et aux colères les plus nombreuses de toute la mythologie.","On l'invoquait aussi sous des noms précis, selon la part de sa protection sollicitée : Xénios veillait sur les hôtes et les étrangers, vengeant lui-même toute entorse aux devoirs de l'hospitalité ; Herkeios protégeait l'autel dressé dans la cour de chaque maison, marque d'une famille reconnue comme telle ; et Horkios, le plus redouté, gardait la sincérité des serments ; sa statue à Olympie, brandissant la foudre, était si terrifiante qu'aucun athlète ni juge ne s'y serait parjuré de sang-froid. Une facette plus modeste, Zeus Ctésios, veillait quant à elle sur les provisions de chaque foyer (voir la fiche « Ctésios »)."],"chiron":[],"éros":[],"apollon":["Fils de Zeus et de Léto (voir la fiche « Léto »), Apollon naquit avec sa sœur jumelle Artémis sur l'île flottante de Délos, seul lieu qui accepta de les accueillir après qu'Héra eut interdit à toute terre ferme de recevoir l'accouchement de sa rivale.","Encore jeune, il prit part comme tous les Olympiens à la Gigantomachie, la guerre que Gaïa déclara à l'Olympe pour venger ses fils titans vaincus : aux côtés du héros mortel Héraclès (voir la fiche « Héraclès »), il visa de sa flèche l'œil resté intact du géant Éphialte, que Héraclès avait déjà frappé de l'autre, un coup double qui l'acheva.","Dieu de la lumière, de la musique et de la vérité, un rôle solaire parfois confondu avec celui d'Hélios (voir la fiche « Hélios »), qui seul conduit réellement le char du soleil, Apollon rend depuis son temple de Delphes (voir la fiche « Temple ») des oracles par la voix de la Pythie : sa devise gravée sur le fronton du temple, « Connais-toi toi-même », résume son exigence de clarté.","Chef de chœur des Muses (voir la fiche « Muses »), qu'il conduit sous le nom d'Apollon Musagète, « guide des Muses », il partage avec elles le mont Parnasse et sa source Castalie, non loin de son propre sanctuaire de Delphes.","Plusieurs surnoms rappellent ses différents visages : Pythien, en souvenir du serpent Python vaincu à Delphes ; Phoibos, « le Brillant », pour son éclat solaire ; et Loxias, « l'Ambigu », pour la nature volontairement obscure de ses oracles, qu'il fallait savoir interpréter plutôt que prendre au pied de la lettre. Un autre surnom, Lycien, reste débattu depuis l'Antiquité même : lié au loup, à la lumière ou à la région de Lycie, sans qu'aucune des trois explications ne l'emporte vraiment sur les autres.","Il connut aussi un amour resté sans retour : ayant un jour raillé le petit arc d'Éros (voir la fiche « Éros »), jugé indigne d'un dieu de son rang, il s'attira la vengeance du dieu vexé : frappé à son tour d'une flèche d'or, il s'éprit aussitôt de la nymphe Daphné (voir la fiche « Daphné »), elle-même atteinte d'une flèche de plomb qui la rendit incapable de l'aimer en retour. Il la poursuivit sans relâche jusqu'aux rives de son père, le dieu-fleuve Pénée, qui la changea en laurier pour la soustraire à ses avances ; Apollon en fit dès lors son arbre sacré, et la couronne de laurier devint le symbole même de la victoire qu'il n'avait pas obtenue ce jour-là (voir la fiche « Laurier »).","Éprise de la princesse thessalienne Coronis (voir la fiche « Coronis »), il apprit d'un corbeau, blanc jusqu'alors, qu'elle lui préférait un mortel alors même qu'elle portait déjà son enfant : furieux, il la fit tuer par Artémis, mais arracha l'enfant du bûcher funéraire in extremis pour le confier à Chiron (voir la fiche « Chiron »). Cet enfant, Asclépios (voir la fiche « Asclépios »), devint un guérisseur si habile qu'il ressuscitait les morts, jusqu'à ce que Zeus, inquiet de le voir bouleverser l'ordre naturel, le foudroie. Fou de chagrin, Apollon se vengea sur les Cyclopes qui avaient forgé cette foudre, un crime qui lui valut d'être condamné à servir un an durant comme simple berger mortel auprès du roi Admète (voir la fiche « Admète »), corvée qu'il transforma en amitié si sincère qu'il obtint plus tard des Parques la grâce de prolonger sa vie. Quant au corbeau messager, resté blanc jusque-là, Apollon le noircit pour toujours en punition de sa nouvelle funeste.","Il aima aussi le jeune prince spartiate Hyacinthe (voir la fiche « Hyacinthe »), avec qui il partageait le goût du disque, jusqu'à ce qu'un disque qu'il lança dévie de sa trajectoire, détourné par le vent jaloux Zéphyr (voir la fiche « Zéphyr »), et frappe mortellement le jeune homme en pleine tempe. Incapable de le sauver, Apollon changea son sang versé en une fleur nouvelle, la jacinthe, sur les pétales de laquelle on croyait pouvoir lire les lettres grecques de son deuil.","Son dernier grand amour resta, lui, sans aucune réciprocité : à la princesse troyenne Cassandre (voir la fiche « Cassandre »), fille de Priam (voir la fiche « Priam »), il offrit le don de prophétie en échange de ses faveurs, mais elle refusa de tenir sa promesse une fois le don reçu. Ne pouvant le lui reprendre, Apollon la frappa d'une malédiction plus cruelle encore : ses prédictions, toujours exactes, ne seraient plus jamais crues par personne, pas même son avertissement, resté sans écho, contre le cheval de bois conçu par Ulysse (voir la fiche « Ulysse »), qui allait livrer Troie aux Grecs."],"thémis":[],"déméter":[],"tyché":[],"héraclès":[],"prométhée":[],"hadès":[],"perséphone":[],"iris":[],"pan":[],"poséidon":["Fils de Cronos et de Rhéa (voir les fiches « Cronos » et « Rhéa »), frère de Zeus et d'Hadès, Poséidon fut lui aussi avalé à la naissance par son père avant d'être délivré par Zeus, et prit une part décisive à la victoire des Olympiens lors de la Titanomachie : les Cyclopes, libérés du Tartare en échange de leur aide, lui forgèrent alors le trident qui reste depuis son arme et son emblème. La guerre gagnée, il reçut la mer en partage lors de la division du cosmos (voir la fiche « Mer »). D'humeur aussi changeante que les flots qu'il gouverne, il peut aussi bien porter les navires que déchaîner tempêtes et tremblements de terre d'un coup de ce même trident.","Lors de la Gigantomachie qui suivit peu après la Titanomachie, quand Gaïa lança une nouvelle génération de géants à l'assaut de l'Olympe, Poséidon pourchassa le géant Polybotès à travers la mer Égée jusqu'à l'île de Cos, dont il arracha un morceau pour l'en écraser ; le fragment détaché serait devenu l'îlot de Nisyros, prison éternelle du géant enseveli dessous.","Sa rivalité avec Athéna pour devenir le patron d'Athènes (il fit jaillir une source d'eau salée du rocher, elle offrit un olivier) illustre bien son tempérament : la force spectaculaire face à la sagesse durable, et c'est cette dernière que la ville choisit.","Trois épithètes résument ses domaines mieux que tout autre : Hippios, pour son lien avec les chevaux qu'il aurait lui-même inventés ; Asphaleios, le « sécurisant », invoqué contre les tremblements de terre qu'il pouvait tout aussi bien provoquer que prévenir ; et Pélagios, pour la haute mer elle-même. Homère l'invoque aussi comme Gaieokhos et Ennosigaios, celui qui « tient » et « secoue » la terre, deux noms qui résument à eux seuls un tempérament capable de porter comme de renverser."],"hécate":[],"séléné":[],"hélios":[],"minos":[],"gaïa":[],"chaos":[],"ouranos":[],"nyx":[],"érèbe":[],"tartare":[],"cronos":[],"océan":[],"téthys":[],"hypérion":[],"théia":[],"coéos":[],"phoebé":[],"crios":[],"eurybie":[],"persès-titan":[],"persès-colchide":[],"astréos":[],"pallas":[],"styx":[],"japet":[],"mnémosyne":[],"épiméthée":[],"ménétios":[],"clymène":[],"athéna":["Née tout armée du crâne de Zeus, après qu'il eut avalé sa mère Métis enceinte (voir la fiche « Métis »), Athéna hérita à la fois de la puissance de son père et de la ruse de sa mère.","Elle n'attendit pas longtemps avant de s'en servir : lors de la Gigantomachie qui suivit peu après sa naissance, elle affronta le géant Encelade et l'écrasa sous l'île de Sicile, un poids si lourd, dit-on, que ses soubresauts continuent d'y provoquer des tremblements de terre. Une autre tradition lui attribue aussi la mort du géant Pallas, dont elle aurait ensuite arraché la peau pour s'en faire une égide.","Déesse de la sagesse stratégique plutôt que de la guerre brutale, elle protège les héros rusés (Ulysse, Persée, Bellérophon) en leur offrant conseils et objets plutôt qu'en combattant à leur place, et devint la patronne d'Athènes après avoir offert à la ville l'olivier, symbole de paix durable.","Il lui arrive aussi d'endosser un rôle plus maternel malgré elle : lorsque Héphaïstos, épris d'elle, la poursuit et se voit repoussé, Gaïa recueille de cette rencontre manquée l'enfant Érichthonios et le confie à Athéna pour qu'elle l'élève (voir les fiches « Héphaïstos » et « Érichthonios »), un enfant qu'elle n'a pas conçu, mais qu'elle protège avec la même rigueur qu'elle réserve à ses héros favoris.","On l'honorait sous plusieurs noms selon la part de sa protection invoquée : Parthénos, « la Vierge », a donné son nom au Parthénon qui la représente sur l'Acropole ; Polias, « gardienne de la cité », désignait son rôle de protectrice d'Athènes elle-même ; et Ergané, « l'Ouvrière », présidait aux travaux des artisans et des tisserandes, un titre qui résonne particulièrement face au destin d'Arachné, changée en araignée pour son insolence (voir la fiche « Araignée »)."],"aphrodite":[],"nérée":[],"bellérophon":[],"éos":[],"niké":[],"hestia":[],"héphaïstos":[],"himeros":[],"énée":[],"anchise":[],"capys":[],"assaracus":[],"tros":[],"ilos":[],"laomédon":[],"créüse":[],"ascagne":[],"silvius":[],"énée-silvius":[],"latinus-silvius":[],"alba":[],"atys":[],"capys-albain":[],"capétus":[],"tiberinus":[],"agrippa":[],"romulus-silvius":[],"aventinus":[],"proca":[],"numitor":[],"amulius":[],"rhéa-silvia":[],"romulus":[],"remus":[],"zéphyr":[],"notos":[],"euros":[],"éole":[],"chloris":[],"triptolème":[],"ploutos":[],"jason":[],"achille":[],"pélée":[],"atlas":[],"atlas-atlantide":[],"psyché":[],"charites":[],"eurynomé":[],"narcisse":[],"écho":[],"circé":[],"thétis":[],"amphitrite":[],"pythie":[],"endymion":[],"charon":[],"ulysse":[],"pénélope":[],"télégonos":[],"télémaque":[],"andromède":[],"hécube":[],"priam":[],"hector":[],"andromaque":[],"molossos":[],"pâris":[],"hélène":[],"castor":[],"pollux":[],"léda":[],"clytemnestre":[],"persée":[],"persès":[],"électryon":[],"sthénélos":[],"eurysthée":[],"gorgophoné":[],"alcée":[],"mestor":[],"héléos":[],"érinyes":[],"actéon":[],"artémis":[],"orion":[],"iphigénie":[],"agamemnon":[],"oreste":[],"asclépios":[],"néoptolème":[],"déidamie":[],"cassandre":[],"hélénos":[],"ménélas":[],"europe":[],"phèdre":[],"égisthe":[],"polyxène":[],"hyacinthe":[],"coronis":[],"daphné":[],"œnone":[],"polydore":[],"polymestor":[],"astyanax":[],"icare":[],"penthée":[],"niobé":[],"otrera":[],"ariane":[],"sémélé":[],"hébé":[],"ilithyie":[],"léto":[],"astéria":[],"cadmos":[],"harmonie":[],"atalante":[],"protée":[],"cyclopes":[],"cybèle":[],"aletheia":[],"ananké":[],"éris":[],"lethée":[],"némésis":[],"palioxis":[],"apaté":[],"phobos":[],"deimos":[],"morphée":[],"thanatos":[],"hormos":[],"arès":[],"thalia":[],"zelos":[],"bia":[],"agon":[],"borée":[],"alké":[],"kratos":[],"philotès":[],"euphrosyne":[],"hypnos":[],"orphée":[],"hyménée":[],"rhéa":[],"kairos":[],"dédale":[],"ctésios":[],"penia":[],"éléos":[],"aristée":[],"techné":[],"aglaé":[],"euthénie":[],"hygie":[],"médée":[],"calliope":[],"cassiopée":[],"mélinoé":[],"ascalaphos":[],"pasiphaé":[],"hermaphrodite":[],"priape":[],"antiope":[],"antiope-thébaine":[],"thésée":[],"hippolyté":[],"hippolyte":[],"didon":[],"érichthonios":[],"alcippé":[],"enyo":[],"hespérides":[],"cécrops":[],"hersé":[],"céphale":[],"procris":[],"céphale-hersé":[],"aglauros":[],"pandrosos":[],"électre":[],"chrysothémis":[],"arachné":[],"leucothoé":[],"clytie":[],"danaé":[],"adonis":[],"myrrha":[],"œagre":[],"crotos":[],"deucalion":[],"pyrrha":[],"pléiades":[],"maïa":[],"hyas":[],"grées":[],"méduse":[],"gorgones":[],"ganymède":[],"myrina":[],"penthésilée":[],"amazones":[],"néréides":[],"harpyes":[],"io":[],"libye":[],"nil":[],"égyptos":[],"danaos":[],"danaïdes":[],"hypermestre":[],"lyncée":[],"byzas":[],"phidaléia":[],"admète":[],"alceste":[],"pélias":[],"clito":[],"sidé":[],"picus":[],"ixion":[],"sisyphe":[],"pirithoos":[],"hippodamie":[],"cyllaros":[],"hylonome":[],"calchas":[],"hyperboréens":[],"abaris":[],"hypsipyle":[],"œdipe":[],"jocaste":[],"antigone":[],"halia":[],"hermione":[],"chryséis":[],"briséis":[],"menthé":[],"pyrame":[],"thisbé":[],"muses":[],"clio":[],"euterpe":[],"thalie":[],"melpomène":[],"terpsichore":[],"érato":[],"polymnie":[],"uranie":[],"heures":[],"parques":[],"épaphos":[],"ino":[],"autonoë":[],"agavé":[],"polydoros":[],"labdacos":[],"laïos":[],"amphion":[],"zéthos":[],"rhadamanthys":[],"sarpédon":[],"alcmène":[],"amphitryon":[],"tyndare":[],"icarios":[],"pélops":[],"atrée":[],"thyeste":[],"acrisios":[],"proétos":[],"bélos":[],"agénor":[],"abas":[],"phaéton":[],"calypso":[],"polyphème":[],"déjanire":[],"méléagre":[],"laërte":[],"anticlée":[],"ctimène":[],"autolycos":[],"nausicaa":[],"alcinoos":[],"tirésias":[],"perséis":[],"aiétès":[]};
...
const DEITY_NAME_OVERRIDES = {
  ...
  "persès-colchide": "Persès (roi de Colchide)",
  ...
  // Bug repéré en marge de l'ajout de Persès (roi de Colchide) : cette entrée avait été oubliée
...
const DEITY_PORTRAITS = {
  ...
  "autolycos": "assets/deity-autolycos.jpg",
  "autonoë": "assets/deity-autonoe.jpg",
  "bélos": "assets/deity-belos.jpg",
  "bellérophon": "assets/deity-bellerophon.jpg",
  "bia": "assets/deity-bia.jpg",
...
const GENEALOGY_PARENTS = {
  ...
  "eurynomé": ["océan", "téthys"],
  "atlas": ["japet", "clymène"],
  // Maïa, l'aînée des sept Pléiades — retour direct de l'utilisatrice : sur la fiche de Zeus,
  // Hermès apparaissait « avec Pléiades » (le collectif) plutôt qu'avec sa mère précise, faute
  // d'une fiche à son nom jusqu'ici. Le père commun aux sept sœurs (Atlas) suffit ici, comme pour
  // "pléiades" elle-même plus bas — pas de fiche pour leur mère Pléioné, mentionnée seulement en
  // prose dans le mythe des Pléiades.
  "maïa": ["atlas"],
  ...
  "heures": ["zeus", "thémis"],
  // Les trois Charites, filles de Zeus et de l'Océanide Eurynomé — cette dernière a désormais sa
  // propre fiche (retour direct de l'utilisatrice : « tu ne les a pas rattachées à la mère »),
  // et le doublon collectif/individuel qu'on acceptait encore ici jusque-là (comme pour les
  // Muses ci-dessus) est corrigé par genealogyChildUnions() elle-même — voir GENEALOGY_GROUP_MEMBERS.
  "charites": ["zeus", "eurynomé"],
  "aglaé": ["zeus", "eurynomé"],
  "euphrosyne": ["zeus", "eurynomé"],
  "thalia": ["zeus", "eurynomé"],
  ...
  "déidamie": [],
  // Perséis, sœur d'Aiétès et de Pasiphaé (voir plus haut) — les trois enfants d'Hélios et de
  // la nymphe Perséis (voir la fiche « Perséis »).
  "perséis": ["océan", "téthys"],
  ...
  "pénélope": ["icarios"],
  "ulysse": ["laërte", "anticlée"],
  "ctimène": ["laërte", "anticlée"],
  "anticlée": ["autolycos"],
  "autolycos": ["hermès"],
  "nausicaa": ["alcinoos"],
  "alceste": ["pélias"],
...
// Groupes toujours représentés ensemble dans les sources antiques, jamais seuls (retour direct
// de l'utilisatrice : « quand il y a des groupes connus ensemble (muses, charites, heures),
// favorise le groupe à part si ça nuit à la cohérence ») — quand la fiche d'un parent liste à la
// fois le collectif ET certains de ses membres nommés individuellement comme enfants directs
// (même union, donc même case), genealogyChildUnions() ci-dessous n'affiche que le collectif :
// les deux à la fois n'ajoutaient rien et faisaient doublon (Zeus listait par ex. « Charites »
// ET « Aglaé », « Euphrosyne », « Thalia » séparément). Les Heures n'ont aucun membre nommé
// individuellement dans le corpus pour l'instant — prêt si un jour l'un d'eux est ajouté.
const GENEALOGY_GROUP_MEMBERS = {
  "muses": ["calliope", "clio", "érato", "euterpe", "melpomène", "polymnie", "terpsichore", "thalie", "uranie"],
  "charites": ["aglaé", "euphrosyne", "thalia"],
  "heures": [],
};
...
function genealogyChildUnions(id){
  ...
  for(const kids of groups.values()){
    for(const [groupId, members] of Object.entries(GENEALOGY_GROUP_MEMBERS)){
      if(kids.includes(groupId)){
        for(let i = kids.length - 1; i >= 0; i--){
          if(members.includes(kids[i])) kids.splice(i, 1);
        }
      }
    }
  }
...
const FREE_PLACE_IDS = new Set(["argos", "athènes-acropole", "atlantide"]);
...
function placeAccess(id){ return FREE_PLACE_IDS.has(id) ? "free" : "premium"; }
...
// Type de contenu premium -> écran attendu, pour éviter de redessiner une fiche que
// l'utilisateur a déjà quittée pendant que la requête était en vol (voir fetchOwnerPreviewContent
// ci-dessous).
const CONTENT_TYPE_SCREEN = { figures: "figureDetail", symbols: "symbolDetail", places: "placeDetail" };
...
function fetchOwnerPreviewContent(type, id){
  ...
  fetch(`api/content?type=${encodeURIComponent(type)}&id=${encodeURIComponent(id)}`, {
    ...
    .then(data => {
      ...
      const expectedScreen = CONTENT_TYPE_SCREEN[type];
...
const MAP_PLACES = [{"id":"delphes","name":"Delphes","category":"sanctuaire","coords":[38.4824,22.501],"desc":"Sanctuaire panhellénique d'Apollon, siège de l'oracle le plus consulté du monde grec.","lore":[],"links":["apollon","pythie","artémis","dionysos"],"symbolLinks":["laurier","serpent"]},{"id":"olympie","name":"Olympie","category":"sanctuaire","coords":[37.6382,21.6296],"desc":"Sanctuaire de Zeus en Élide, où se tenaient tous les quatre ans les Jeux olympiques.","lore":[],"links":["zeus","héra","pélops"],"symbolLinks":[]},{"id":"éleusis","name":"Éleusis","category":"sanctuaire","coords":[38.045,23.545],"desc":"Sanctuaire de Déméter et Perséphone, siège des Mystères d'Éleusis.","lore":[],"links":["déméter","perséphone","hadès","triptolème"],"symbolLinks":["blé"]},{"id":"dodone","name":"Dodone","category":"sanctuaire","coords":[39.546,20.788],"desc":"Plus ancien sanctuaire oraculaire de Grèce, où Zeus parlait par le bruissement d'un chêne sacré.","lore":[],"links":["zeus"],"symbolLinks":["chêne"]},{"id":"délos","name":"Délos","category":"sanctuaire","coords":[37.396,25.269],"desc":"Île sacrée où naquirent Apollon et Artémis, centre religieux majeur des Cyclades.","lore":[],"links":["apollon","artémis","léto"],"symbolLinks":[]},{"id":"épidaure","name":"Épidaure","category":"sanctuaire","coords":[37.5959,23.0778],"desc":"Principal sanctuaire de guérison du monde grec, dédié à Asclépios.","lore":[],"links":["asclépios","apollon"],"symbolLinks":["serpent"]},{"id":"mont-olympe","name":"Mont Olympe","category":"montagne","coords":[40.0855,22.3583],"desc":"La plus haute montagne de Grèce, séjour légendaire des douze dieux olympiens.","lore":[],"links":["zeus","héra","poséidon","athéna","apollon","artémis","arès","aphrodite","héphaïstos","hermès","déméter","dionysos"],"symbolLinks":[]},{"id":"mont-ida-crète","name":"Mont Ida (Crète)","category":"montagne","coords":[35.25,24.75],"desc":"Montagne de Crète où Zeus enfant fut caché et élevé, loin de son père Cronos.","lore":[],"links":["zeus","cronos"],"symbolLinks":["chèvre"]},{"id":"mont-parnasse","name":"Mont Parnasse","category":"montagne","coords":[38.53,22.59],"desc":"Montagne sacrée d'Apollon et des Muses, surplombant Delphes.","lore":[],"links":["apollon","deucalion","pyrrha"],"symbolLinks":[]},{"id":"mont-hélicon","name":"Mont Hélicon","category":"montagne","coords":[38.3167,22.85],"desc":"Montagne de Béotie consacrée aux Muses, où jaillit la source Hippocrène.","lore":[],"links":[],"symbolLinks":["pégase"]},{"id":"athènes-acropole","name":"Athènes (Acropole)","category":"cité","coords":[37.9715,23.7267],"desc":"Citadelle sacrée d'Athènes, consacrée à Athéna après sa victoire sur Poséidon.","lore":["Selon la tradition rapportée par Apollodore, Athéna et Poséidon se disputèrent la protection de la ville naissante : Poséidon en fit jaillir une source d'eau salée en frappant le rocher de son trident, tandis qu'Athéna y fit pousser le premier olivier ; jugée plus utile aux habitants, l'offrande d'Athéna lui valut la victoire et donna son nom à la cité.","Le Parthénon, temple dédié à Athéna Parthénos (« la Vierge »), y fut construit au Ve siècle av. J.-C. sous Périclès pour abriter une statue chryséléphantine monumentale de la déesse, également sculptée par Phidias."],"links":["athéna","poséidon"],"symbolLinks":["olivier","chouette"]},{"id":"mycènes","name":"Mycènes","category":"cité","coords":[37.7307,22.7563],"desc":"Citadelle légendaire d'Agamemnon, chef de l'expédition grecque contre Troie.","lore":[],"links":["agamemnon","clytemnestre","égisthe"],"symbolLinks":[]},{"id":"thèbes","name":"Thèbes","category":"cité","coords":[38.32,23.32],"desc":"Cité fondée par Cadmos, théâtre du cycle mythologique d'Œdipe et de sa descendance.","lore":[],"links":["cadmos","œdipe","dionysos"],"symbolLinks":[]},{"id":"troie","name":"Troie","category":"cité","coords":[39.9576,26.2386],"desc":"Cité assiégée dix ans par les Grecs, théâtre de l'Iliade d'Homère.","lore":[],"links":["hélène","pâris","ulysse","hector","priam","achille"],"symbolLinks":[]},{"id":"sparte","name":"Sparte","category":"cité","coords":[37.0755,22.4238],"desc":"Cité de Ménélas et d'Hélène, en Laconie.","lore":[],"links":["ménélas","hélène","castor","pollux"],"symbolLinks":[]},{"id":"argos","name":"Argos","category":"cité","coords":[37.6333,22.7333],"desc":"L'une des plus anciennes cités de Grèce, particulièrement consacrée au culte d'Héra.","lore":["Argos abritait l'Héraion, l'un des plus importants sanctuaires d'Héra du monde grec, où la déesse était honorée comme protectrice du mariage et de la cité elle-même, un culte si central que la région tout entière, l'Argolide, lui était traditionnellement associée.","La cité fut aussi, selon Apollodore, le lieu de naissance de Persée, né de l'union de Zeus et de Danaé alors que celle-ci était enfermée par son père Acrisios dans une chambre souterraine de bronze, pour tenter d'échapper à une prophétie qui annonçait sa propre mort par la main de son petit-fils.","Argos fut aussi, selon Les Suppliantes d'Eschyle, la terre d'accueil de Danaos et de ses cinquante filles, les Danaïdes, fuyant un mariage forcé imposé par leurs cinquante cousins égyptiens ; le roi argien Pélasgos, dit-on, n'accepta de les protéger qu'après consultation du peuple tout entier, un épisode que la tragédie présente comme l'un des premiers gestes démocratiques de la légende grecque. Danaos y devint roi à son tour, fondant une dynastie dont Persée, déjà lié à la cité par sa naissance, descend directement."],"links":["héra","persée","danaé","acrisios","danaos","danaïdes"],"symbolLinks":[]},{"id":"corinthe","name":"Corinthe","category":"cité","coords":[37.9061,22.8781],"desc":"Cité isthmique associée à Sisyphe et à l'épisode grec de Médée.","lore":[],"links":["sisyphe","médée","jason","hélios"],"symbolLinks":[]},{"id":"cnossos","name":"Cnossos","category":"cité","coords":[35.2977,25.1633],"desc":"Palais crétois du roi Minos, siège légendaire du Labyrinthe et du Minotaure.","lore":[],"links":["minos","pasiphaé","dédale","thésée","ariane"],"symbolLinks":["labyrinthe","taureau","fil"]},{"id":"ithaque","name":"Ithaque","category":"île","coords":[38.42,20.71],"desc":"Île-royaume d'Ulysse, dans les îles Ioniennes.","lore":[],"links":["ulysse","pénélope","poséidon"],"symbolLinks":["fil"]},{"id":"naxos","name":"Naxos","category":"île","coords":[37.1036,25.4761],"desc":"Île où Ariane, abandonnée par Thésée, fut trouvée par Dionysos.","lore":[],"links":["ariane","thésée","dionysos"],"symbolLinks":["couronne"]},{"id":"lemnos","name":"Lemnos","category":"île","coords":[39.917,25.137],"desc":"Île où Héphaïstos, rejeté de l'Olympe, retomba et établit sa forge.","lore":[],"links":["héphaïstos","héra","zeus"],"symbolLinks":[]},{"id":"samothrace","name":"Samothrace","category":"île","coords":[40.5,25.528],"desc":"Île du nord de l'Égée, siège des mystères des Grands Dieux (Cabires).","lore":[],"links":[],"symbolLinks":[]},{"id":"rhodes","name":"Rhodes","category":"île","coords":[36.4341,28.2176],"desc":"Île consacrée au dieu solaire Hélios, qui érigea le Colosse à son entrée de port.","lore":[],"links":["hélios","zeus"],"symbolLinks":[]},{"id":"samos","name":"Samos","category":"île","coords":[37.75,26.9833],"desc":"Île égéenne où se trouvait l'un des plus grands sanctuaires d'Héra du monde grec.","lore":[],"links":["héra"],"symbolLinks":[]},{"id":"hellespont","name":"Hellespont (Dardanelles)","category":"détroit","coords":[40.2,26.4],"desc":"Détroit des Dardanelles, nommé d'après Hellé, tombée dans ses eaux.","lore":[],"links":["aphrodite"],"symbolLinks":[]},{"id":"détroit-de-messine","name":"Détroit de Messine","category":"détroit","coords":[38.23,15.63],"desc":"Détroit séparant l'Italie de la Sicile, repaire mythique de Charybde et Scylla.","lore":[],"links":["ulysse"],"symbolLinks":[]},{"id":"colonnes-d-héraclès","name":"Colonnes d'Héraclès (Gibraltar)","category":"détroit","coords":[36.1408,-5.3536],"desc":"Détroit de Gibraltar, limite occidentale du monde connu des Grecs anciens.","lore":[],"links":["héraclès"],"symbolLinks":[]},{"id":"bosphore","name":"Bosphore","category":"détroit","coords":[41.12,29.07],"desc":"Détroit séparant l'Europe de l'Asie, nommé d'après le passage de la génisse Io.","lore":[],"links":["io","héra","zeus"],"symbolLinks":[]},{"id":"source-castalie","name":"Source Castalie","category":"source","coords":[38.4841,22.5029],"desc":"Source sacrée de Delphes où les pèlerins et la Pythie devaient se purifier.","lore":[],"links":["apollon","pythie"],"symbolLinks":["source"]},{"id":"fleuve-alphée","name":"Fleuve Alphée","category":"source","coords":[37.64,21.65],"desc":"Principal fleuve d'Élide, qui traverse le sanctuaire d'Olympie.","lore":[],"links":["héraclès","artémis"],"symbolLinks":["source"]},{"id":"achéron-nekromanteion","name":"Nekromanteion de l'Achéron","category":"monde souterrain","coords":[39.227,20.47],"desc":"Site d'Épire identifié dans l'Antiquité à une entrée des Enfers, sur les rives de l'Achéron.","lore":[],"links":["hadès","charon"],"symbolLinks":["monde souterrain"]},{"id":"cap-ténare","name":"Cap Ténare","category":"monde souterrain","coords":[36.3833,22.4833],"desc":"Pointe la plus méridionale du Péloponnèse, où s'ouvrait, selon la tradition, une entrée des Enfers.","lore":[],"links":["héraclès","orphée","hadès"],"symbolLinks":["monde souterrain","serpent"]},{"id":"aulis","name":"Aulis","category":"cité","coords":[38.4,23.5967],"desc":"Port de Béotie d'où la flotte grecque appareilla pour Troie, après le sacrifice d'Iphigénie.","lore":[],"links":["agamemnon","artémis","calchas"],"symbolLinks":[]},{"id":"éphèse","name":"Éphèse","category":"sanctuaire","coords":[37.9395,27.3417],"desc":"Cité d'Ionie abritant le célèbre temple d'Artémis, l'une des Sept Merveilles du monde antique.","lore":[],"links":["artémis"],"symbolLinks":[]},{"id":"carthage","name":"Carthage","category":"cité","coords":[36.8528,10.3233],"desc":"Cité fondée par la reine Didon, où elle aima puis perdit Énée.","lore":[],"links":["didon","énée"],"symbolLinks":[]},{"id":"lavinium","name":"Lavinium","category":"cité","coords":[41.6667,12.4833],"desc":"Cité fondée par Énée en Italie, berceau légendaire du peuple romain.","lore":[],"links":["énée","ascagne"],"symbolLinks":[]},{"id":"joppé","name":"Joppé (rocher d'Andromède)","category":"cité","coords":[32.0533,34.75],"desc":"Cité portuaire où la tradition antique situait le rocher où Andromède fut enchaînée en offrande au monstre marin.","lore":[],"links":["andromède","persée","cassiopée"],"symbolLinks":["chaîne"]},{"id":"jardin-des-hespérides","name":"Repaire des Gorgones et jardin des Hespérides","category":"montagne","coords":[31.06,-7.92],"desc":"Aux confins occidentaux du monde connu, près du Titan Atlas : repaire des Gorgones et verger aux pommes d'or des Hespérides.","lore":[],"links":["gorgones","méduse","grées","hespérides","atlas","héraclès"],"symbolLinks":["pomme","serpent"]},{"id":"atlantide","name":"Atlantide","category":"île","coords":[34.5,-12.0],"desc":"Île légendaire décrite par Platon, engloutie en un jour et une nuit, un récit philosophique plutôt qu'un site archéologique attesté.","lore":["C'est dans le Timée et le Critias que Platon décrit, seul parmi les auteurs antiques, une île immense au-delà des Colonnes d'Héraclès, plus vaste que la Libye et l'Asie réunies, gouvernée par les descendants d'Atlas, fils de Poséidon (voir la fiche « Poséidon ») et de la mortelle Clito (voir la fiche « Clito »).","Prospère et puissante, l'Atlantide sombra selon Platon dans la mer en un seul jour et une seule nuit funestes, punition d'une démesure qui l'avait éloignée de sa sagesse originelle. Débattue depuis l'Antiquité même (simple allégorie philosophique pour certains, souvenir déformé d'une catastrophe réelle pour d'autres), elle n'a jamais été localisée par aucune découverte archéologique."],"links":["atlas-atlantide","poséidon","clito"],"symbolLinks":["trident"]},{"id":"libye-mythologique","name":"Libye (région)","category":"cité","coords":[27.0,17.0],"desc":"Territoire éponyme de la nymphe Libye, à l'origine de toute une lignée qui essaimera jusqu'à Argos et la Phénicie.","lore":[],"links":["libye","nil","bélos","agénor"],"symbolLinks":[]},{"id":"tyr","name":"Tyr","category":"cité","coords":[33.2704,35.1937],"desc":"Cité phénicienne fondée par Agénor, où Zeus changé en taureau enleva la princesse Europe.","lore":[],"links":["agénor","europe","cadmos"],"symbolLinks":["taureau"]},{"id":"colchide","name":"Colchide","category":"cité","coords":[42.2679,42.7],"desc":"Royaume du roi Éétès, où était gardée la Toison d'or convoitée par Jason et les Argonautes.","lore":[],"links":["jason","médée"],"symbolLinks":["bélier"]},{"id":"tirynthe","name":"Tirynthe","category":"cité","coords":[37.5997,22.8004],"desc":"Cité d'où le roi Eurysthée imposa à Héraclès ses douze travaux.","lore":[],"links":["héraclès","amphitryon","alcmène","eurysthée","alcée"],"symbolLinks":["lion"]},{"id":"colone","name":"Colone","category":"cité","coords":[38.0,23.72],"desc":"Dème proche d'Athènes où Œdipe, aveugle et exilé, trouva une fin apaisée sous la protection de Thésée.","lore":[],"links":["œdipe","antigone","thésée"],"symbolLinks":[]},{"id":"calydon","name":"Calydon","category":"cité","coords":[38.3667,21.5333],"desc":"Royaume d'Œnée, ravagé par le sanglier envoyé par Artémis en punition d'un sacrifice oublié.","lore":[],"links":["méléagre","atalante","artémis"],"symbolLinks":["sanglier"]},{"id":"styx","name":"Le Styx","category":"source","coords":[37.9667,22.2333],"desc":"Chute d'eau d'Arcadie que les Anciens montraient comme l'incarnation terrestre du Styx, le fleuve des Enfers sur lequel les dieux juraient leurs serments les plus sacrés.","lore":[],"links":["styx","charon","hadès"],"symbolLinks":["eau"]},{"id":"fleuve-lethée","name":"Le Lethée","category":"source","coords":[39.24,20.44],"desc":"Fleuve infernal de l'Oubli, moins un site précis qu'une image littéraire, que les Anciens rattachaient à la région des fleuves des Enfers, en Épire.","lore":[],"links":["lethée","styx","hadès"],"symbolLinks":["eau"]},{"id":"salmacis","name":"Source Salmacis","category":"source","coords":[37.0384,27.4241],"desc":"Source de Carie où la naïade Salmacis, éprise d'Hermaphrodite, obtint des dieux de fusionner à jamais avec lui en un seul être.","lore":[],"links":["hermaphrodite"],"symbolLinks":["eau"]},{"id":"inachos","name":"Fleuve Inachos","category":"source","coords":[37.63,22.7],"desc":"Dieu-fleuve d'Argolide, père d'Io, changée en génisse blanche pour fuir la jalousie d'Héra.","lore":[],"links":["io","héra","zeus"],"symbolLinks":["eau"]},{"id":"céphise","name":"Fleuve Céphise","category":"source","coords":[38.485,22.6],"desc":"Dieu-fleuve de Phocide, père de Narcisse selon la tradition la plus répandue.","lore":[],"links":["narcisse","écho"],"symbolLinks":["narcisse-fleur"]},{"id":"enna","name":"Plaine d'Enna","category":"monde souterrain","coords":[37.5662,14.2792],"desc":"Site sicilien le plus solidement attesté pour l'enlèvement de Perséphone par Hadès.","lore":[],"links":["perséphone","hadès","déméter"],"symbolLinks":["grenade"]},{"id":"lac-averne","name":"Lac Averne","category":"monde souterrain","coords":[40.8272,14.0722],"desc":"Lac volcanique de Campanie que les Romains croyaient être une entrée des Enfers, par où Énée descendit guidé par la Sibylle.","lore":[],"links":["énée","anchise"],"symbolLinks":[]},{"id":"plutonium-hiérapolis","name":"Plutonium de Hiérapolis","category":"monde souterrain","coords":[37.9242,29.1247],"desc":"Grotte de Phrygie que Strabon décrit comme une porte des Enfers consacrée à Hadès, un site aux émanations réellement mortelles, confirmé par l'archéologie moderne.","lore":[],"links":["hadès","cybèle"],"symbolLinks":[]},{"id":"île-de-circé","name":"Île de Circé (Aiaié)","category":"île","coords":[41.2394,13.0578],"desc":"Promontoire italien qu'on identifiait dès l'Antiquité à Aiaié, l'île de la magicienne Circé, qui y changea les compagnons d'Ulysse en pourceaux.","lore":[],"links":["circé","ulysse","hermès"],"symbolLinks":[]},{"id":"ogygie","name":"Ogygie","category":"île","coords":[36.0443,14.2439],"desc":"Île de la nymphe Calypso, qui y retint Ulysse sept années ; aucun site n'est attesté avec certitude dans l'Antiquité, mais la tradition la plus reprise, y compris aujourd'hui, la situe à Gozo, sur l'archipel maltais.","lore":[],"links":["ulysse","calypso","hélios","zeus"],"symbolLinks":[]},{"id":"île-des-cyclopes","name":"Île des Cyclopes","category":"île","coords":[37.5619,15.1633],"desc":"Repaire du cyclope Polyphème, que la tradition la plus tardive situe en Sicile, près de l'Etna ; les îlots au large d'Aci Trezza portent aujourd'hui encore le nom d'Isole dei Ciclopi.","lore":[],"links":["ulysse","polyphème","poséidon"],"symbolLinks":[]},{"id":"île-d-éole","name":"Île d'Éole","category":"île","coords":[38.4667,14.95],"desc":"Île flottante du maître des vents Éole, qui offrit à Ulysse une outre enfermant tous les vents contraires ; les îles Éoliennes, au nord de la Sicile, portent encore son nom.","lore":[],"links":["éole","ulysse","zeus"],"symbolLinks":[]},{"id":"schérie","name":"Schérie","category":"île","coords":[39.6243,19.9217],"desc":"Île des Phéaciens où Nausicaa recueillit Ulysse naufragé ; identifiée à Corfou dès l'Antiquité, déjà chez Thucydide.","lore":[],"links":["ulysse","nausicaa","alcinoos","calypso"],"symbolLinks":[]},{"id":"île-des-lotophages","name":"Île des Lotophages","category":"île","coords":[33.8076,10.8451],"desc":"Terre où poussait le lotus, dont le fruit faisait perdre à quiconque en mangeait tout désir de rentrer chez lui ; Hérodote l'identifiait déjà à Djerba.","lore":[],"links":["ulysse"],"symbolLinks":["lotus"]},{"id":"buthrote","name":"Buthrote","category":"cité","coords":[39.7486,20.0233],"desc":"Royaume d'Hélénos et Andromaque en Épire, où Énée fait escale dans l'Énéide, aujourd'hui un site archéologique classé à l'UNESCO.","lore":[],"links":["hélénos","andromaque","énée"],"symbolLinks":[]},{"id":"drépane","name":"Drépane (Eryx)","category":"cité","coords":[38.0387,12.5878],"desc":"Cité sicilienne où meurt Anchise dans l'Énéide, et où Énée organise en son honneur des jeux funèbres.","lore":[],"links":["anchise","énée"],"symbolLinks":[]},{"id":"strophades","name":"Strophades","category":"île","coords":[37.2667,21.0],"desc":"Îlots où les Harpyes maudissent Énée et ses compagnons dans l'Énéide.","lore":[],"links":["harpyes","énée"],"symbolLinks":["chèvre"]},{"id":"byzance","name":"Byzance","category":"cité","coords":[41.0086,28.9802],"desc":"Cité fondée par Byzas au confluent du Bosphore et de la Corne d'Or, future Constantinople puis Istanbul.","lore":[],"links":["byzas","poséidon","phidaléia"],"symbolLinks":[]}];
...
function placePopupContent(place){
  ...
  el.innerHTML = `
    <strong>${escapeHTML(place.name)}${placeAccess(place.id) === "premium" ? ' 🔒' : ""}</strong>
...
function renderPlaceDetail(id){
  ...
  let lore = p.lore || [];
  if(placeAccess(id) === "premium" && !isPremiumUnlocked()){
    if(!hasOwnerPreview()) return renderPaywall({ name: p.name, note: p.desc });
    const cached = OWNER_PREVIEW_CACHE.places[id];
    if(!cached || cached.loading){
      fetchOwnerPreviewContent("places", id);
      return renderOwnerPreviewLoading({ name: p.name, note: p.desc });
    }
    if(cached.locked) return renderPaywall({ name: p.name, note: p.desc });
    lore = cached.content.lore;
  }
  ...
  return `
    ...
    <article class="detail place-detail">
      ...
      ${lore.map(par => `<p class="lore-text">${linkifyLore(par)}</p>`).join("")}
...
//
// Bug remonté par l'utilisatrice, à deux visages en apparence différents mais de même origine :
// (1) une réponse par ailleurs exacte (Aiétès → Hélios) refusée comme fausse, et (2) « Perséis »
// affiché deux fois dans la même ronde. Dans les deux cas, l'ancienne version ne vérifiait que
// l'ÉGALITÉ des parents une fois TIRÉS AU SORT (`quizPick`), jamais le chevauchement des
// ENSEMBLES de parents possibles ni la présence d'une même figure des deux côtés — deux figures
// aux parents partagés (Aiétès et Pasiphaé partagent {Hélios, Perséis}) pouvaient donc se voir
// assigner chacune un parent différent du même ensemble, rendant strictement indissociables les
// deux bonnes réponses pour l'utilisatrice : taper le VRAI père d'Aiétès pouvait tomber sur la
// réponse que le jeu avait réservée à Pasiphaé. Corrigé en excluant toute sélection où deux
// figures partagent ne serait-ce qu'un seul parent en commun, et où une figure servant de sujet
// (colonne de gauche) réapparaît comme réponse-parent (colonne de droite) dans la même ronde.
function quizGenMatch(scopeIds){
  const candidates = scopeIds.filter(id => (GENEALOGY_PARENTS[id] || []).length > 0);
  if(candidates.length < 4) return null;
  for(let attempt = 0; attempt < 30; attempt++){
    const chosen = quizSample(candidates, 4);
    const parentSets = chosen.map(id => new Set(GENEALOGY_PARENTS[id]));
    let sharesParent = false;
    for(let i = 0; i < parentSets.length && !sharesParent; i++){
      for(let j = i + 1; j < parentSets.length; j++){
        for(const p of parentSets[i]){
          if(parentSets[j].has(p)){ sharesParent = true; break; }
        }
        if(sharesParent) break;
      }
    }
    ...
    if(chosen.some(id => parentIds.includes(id))) continue;
